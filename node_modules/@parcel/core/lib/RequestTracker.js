...
class RequestTracker {
  ...
  hasValidResult(id) {
    return !this.graph.invalidNodeIds.has(id) && !this.graph.incompleteNodeIds.has(id);
  }
...
class RequestRunner {
  ...
  onComplete(request, result, api) {
    throw new Error(`RequestRunner for type ${this.type} did not implement onComplete()`);
  }
