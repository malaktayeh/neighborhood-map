...
async function loadTSConfig(config, options) {
  ...
  let parsedConfig = ts.parseJsonConfigFileContent(configResult, host, _path.default.dirname((0, _nullthrows.default)(config.resolvedPath))); // Add all of the extended config files to be watched
