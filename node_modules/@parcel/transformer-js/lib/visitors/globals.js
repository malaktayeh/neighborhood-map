...
var _default = {
  Identifier(node, asset, ancestors) {
    ...
    if (VARS.hasOwnProperty(node.name) && !(0, _nullthrows.default)(asset.meta.globals).has(node.name) && types.isReferenced(node, parent) && !types.isModuleSpecifier(parent) && !(0, _utils.hasBinding)(ancestors, node.name)) {
